...
module ActiveMerchant #:nodoc:
  module Billing #:nodoc:
    ...
    class Gateway
      ...
      # :dollars => '12.50'
      # :cents => '1250'
      class_accessor :money_format
      self.money_format = :dollars
      
      # The default currency for the transactions if no currency is provided
      class_accessor :default_currency
      
      # The countries of merchants the gateway supports
      class_accessor :supported_countries
      self.supported_countries = []
      
      # The supported card types for the gateway
      class_accessor :supported_cardtypes
      self.supported_cardtypes = []
      
      class_accessor :homepage_url
      class_accessor :display_name
